...
public class ClientPersonalData {
    ...
    public ClientPersonalData(String firstName, String lastName, String pesel, String idCard, String country, String voivodeship, String city, String street, String buildingNumber, String flatNumber, BigInteger clientKeyId) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.pesel = pesel;
        this.idCard = idCard;
