...
CREATE TABLE employees_key (employee_key_id SERIAL PRIMARY KEY, login VARCHAR(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL, password VARCHAR(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL) ENGINE = InnoDB;
