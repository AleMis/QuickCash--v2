...
public class ClientDataPanelController {
    ...
    public void initClientPersonalData() {
        ClientPersonalData clientPersonalData = CommunicationDAO.selectById(SELECT_CLIENT_PERSONAL_DATA_BY_ID, getClientKey().getClientKeyId());
    ...
    public void initClientContactDetails() {
        ClientContactDetails clientContactDetails = CommunicationDAO.selectById(SELECT_CLIENT_CONTACT_DETAILS_BY_ID, getClientKey().getClientKeyId());
